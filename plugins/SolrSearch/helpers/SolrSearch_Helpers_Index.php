    ...
    foreach ($item->getAllElementTexts() as $text) {
      ...
      foreach ($item->getFiles() as $file) {
        if ($file->getExtension() == 'xml') {
          ...
          $contents = file_get_contents($serverRoot."/omeka/files/original/".metadata($file,'filename'));
          ...
          $xml = simplexml_load_file($serverRoot."/omeka/files/original/".metadata($file,'filename'));
        }
      }
